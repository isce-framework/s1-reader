...
class BurstNoise: #For thermal noise correction
    ...
    def from_noise_annotation(cls, noise_annotation: NoiseAnnotation, azimuth_time: datetime.datetime,
        ...
        return cls(range_azimith_time, range_line, range_pixel, range_lut,
    ...
    def export_lut(self):
        '''Returns the LUT table for thermal noise correction whose size is the same as the burst SLC'''
...
class BurstEAP:
    ...
    def export_lut(self):
        '''Returns LUT for EAP correction. Parts of the codes were borrowed from ISCE2.
